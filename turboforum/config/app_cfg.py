# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in turboforum.
...
from turboforum.lib import app_globals, helpers 
...
base_config.package = turboforum
...
base_config.model = turboforum.model
base_config.DBSession = turboforum.model.DBSession
# Configure the authentication backend

# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP 
base_config.sa_auth.cookie_secret = "cec323ba-a9e2-4363-8234-37796eb2b0c2"
